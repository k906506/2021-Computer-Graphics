...
def calc_derivatives(src):
    ...
    :return: Ix, Iy
    """
    sobel_x, sobel_y = get_my_sobel()  # 1. sobel_x, y 추출
    Ix = my_filtering(src, sobel_x)  # 2. 2에서 추출한 sobel_x, y 적용한 Ix, Iy 추출
...
def HarrisDetector(src, gaus_filter_size=3, gaus_sigma=1, alpha=0.04, threshold_rate=0.01):
    ...
    cv2.imshow('201701971 - dst_x_Norm', dst_x_Norm)
    cv2.imshow('201701971 - dst_y_Norm', dst_y_Norm)
    cv2.waitKey()
    cv2.destroyWindow('201701971 - dst_x_Norm')
    cv2.destroyWindow('201701971 - dst_y_Norm')
    ...
    cv2.imshow('201701971 - IxIx', IxIx)
    cv2.imshow('201701971 - IyIy', IyIy)
    # cv2.imshow('IxIy', IxIy)
    cv2.imshow('201701971 - dst_IxIy_Norm', dst_IxIy_Norm)
    cv2.waitKey()
    cv2.destroyWindow('201701971 - IxIx')
    cv2.destroyWindow('201701971 - IyIy')
    # cv2.destroyWindow('IxIy')
    cv2.destroyWindow('201701971 - dst_IxIy_Norm')
    ...
    cv2.imshow('201701971 - G_IxIx', G_IxIx)
    cv2.imshow('201701971 - G_IyIy', G_IyIy)
    # cv2.imshow('G_IxIy', G_IxIy)
    cv2.imshow('201701971 - G_dst_IxIy_Norm', G_dst_IxIy_Norm)
    cv2.waitKey()
    cv2.destroyWindow('201701971 - G_IxIx')
    cv2.destroyWindow('201701971 - G_IyIy')
    # cv2.destroyWindow('G_IxIy')
    cv2.destroyWindow('201701971 - G_dst_IxIy_Norm')
    ...
    cv2.imshow('201701971 - har before threshold', G_dst_har_Norm)
    ...
    cv2.imshow('201701971 - har after threshold', G_dst_har_thresh_Norm)
...
def main():
    ...
    cv2.imshow('201701971 - original', src)
    ...
    cv2.imshow('201701971 - interest points', interest_points)
    cv2.imshow('201701971 - harris_img', harris_img)
    cv2.waitKey()
