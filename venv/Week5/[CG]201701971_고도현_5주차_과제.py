...
def calc_M_integral(IxIx_integral, IyIy_integral, IxIy_integral, fsize=5):
...
def main():
    ...
    cv2.imshow('harris_img ' + "201701971", harris_img)
    cv2.imshow('harris_integral_img ' + "201701971", harris_integral_img)
    cv2.waitKey()
